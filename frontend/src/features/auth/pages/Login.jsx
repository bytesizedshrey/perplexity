...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center dot-matrix-bg text-neutral-200 relative overflow-hidden terminal-grid">
      ...
      <div className="absolute top-8 left-8 opacity-30 pointer-events-none select-none">
      ...
      <div className="absolute bottom-8 right-8 opacity-30 pointer-events-none select-none">
      ...
      <div className="absolute top-8 right-16 opacity-15 pointer-events-none select-none">
        <DotmDisplay size={40} dotSize={5} color="#222" pattern="outline" />
      </div>
      <div className="absolute bottom-16 left-12 opacity-15 pointer-events-none select-none">
        ...
        <div className="mb-8 flex flex-col items-center text-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1.5 text-[11px] font-mono text-neutral-600">
              Authorization required to access terminal.
            </p>
          </div>
        </div>
